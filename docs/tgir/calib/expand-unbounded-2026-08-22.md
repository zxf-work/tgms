...
**Measured 2026-08-22.** `TGIR_SPEC.md` §2.3 makes this an M3
...
| machine | Linux-5.4.0-216-generic-x86_64-with-glibc2.31 |
...
|---|---|---|---|---|---|
| ten bound anchors | 10 | 18920 | 1,196,620 | 411.353 | 343.8 |
| hoisted over the whole population | 1899 | 3611834 | 228,434,774 | 61510.293 | 269.3 |

## Coefficient

```
TIME_COEFF_MS_PER_M["tgir_expand_unbounded"] = 343.8
```
