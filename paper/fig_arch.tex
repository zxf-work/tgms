...
\begin{tikzpicture}[
  ...
  band/.style={base, draw=tgmsdeep!60, fill=tgmsdeep!6, thick, text width=86mm},
...
\node[band, fill=tgmsdeep!11] (store) at (8.7,-3.85)
...
\node[llm, text width=36mm] (rep) at (2.0,-6.1)
...
% ---- trust boundary --------------------------------------------------------
\node[draw=tgmsblue!70, dashed, very thick, rounded corners=8pt, inner sep=9pt,
      fit=(ver)(exec)(tools)(store)(cver)] (tcb) {};
\node[font=\scriptsize\bfseries, text=tgmsblue!80!black,
      anchor=south east] at (tcb.south east) {TRUSTED (deterministic, contract-enforced)};
\node[font=\scriptsize\bfseries, text=tgmsamber!90!black, rotate=90,
      anchor=south] at ($(plan.west)!0.5!(rep.west)+(-0.45,0)$) {UNTRUSTED (LLM)};
